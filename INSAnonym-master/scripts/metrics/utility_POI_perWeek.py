...
#/\/\/\/\/\/\ Nom de la métrique: Extraction des Points d’Intérêts (Version par semaine) /\/\/\/\/\/\
...
#
#Dans le cadre de ce fichier d'utilité, nous regardons par défaut 1 POI pour chaque semaine de chaque individu.
...
def main(originalFile, anonymisedFile, parameters={"size":2,"nbPOI":1,"night_start":22,"night_end":6,"work_start":9,"work_end":16,"weekend_start":10,"weekend_end":18}):
	global size
