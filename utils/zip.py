...
# Example Usage
csv_file = "origin_data/bigger_survey_results.csv"   # Replace with your CSV file path
zip_file = "origin_data/bigger_survey_results.zip"  # Replace with your desired ZIP file path
